...
//333744/1759489/2.50/3/3/MOSFET P-Channel
...
(library Library_1
	...
	(symbolDef "SI2343CDS-T1-GE3" (originalName "SI2343CDS-T1-GE3")
	...
	(compDef "SI2343CDS-T1-GE3" (originalName "SI2343CDS-T1-GE3") (compHeader (numPins 3) (numParts 1) (refDesPrefix Q)
		)
		...
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "SI2343CDS-T1-GE3"))
		...
		(attr "Mouser Part Number" "781-SI2343CDS-T1-GE3")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/Vishay-Semiconductors/SI2343CDS-T1-GE3?qs=WX95TUc1y56rXCTRPp%252BkZQ%3D%3D")
		(attr "Manufacturer_Name" "Vishay")
		(attr "Manufacturer_Part_Number" "SI2343CDS-T1-GE3")
		(attr "Description" "Trans MOSFET P-CH 30V 4.2A 3-Pin Vishay SI2343CDS-T1-GE3 P-channel MOSFET Transistor, 4.7 A, -30 V, 3-Pin TO-236")
		(attr "<Hyperlink>" "https://datasheet.datasheetarchive.com/originals/distributors/Datasheets-DGA23/1582493.pdf")
		(attr "<Component Height>" "1.12")
		(attr "<STEP Filename>" "SI2343CDS-T1-GE3.stp")
